...
function tpgb_tp_dark_mode_render_callback( $attributes, $content) {
	...
	$output .= '<div class="tpgb-dark-mode dark-pos-'.esc_attr($dmPosition).' darkmode-'.esc_attr($dmStyle).' tpgb-block-'.esc_attr($block_id).' '.esc_attr($blockClass).'" data-id="tpgb-block-'.esc_attr($block_id).'" data-save-cookies="'.esc_attr($saveCookies).'" data-match-os="'.esc_attr($matchOsTheme).'">';
