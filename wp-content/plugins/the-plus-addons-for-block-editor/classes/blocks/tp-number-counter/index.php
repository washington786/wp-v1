...
function tpgb_tp_number_counter_render_callback( $attributes, $content) {
	...
	if(!empty($linkURL)){
		$getTitle .='<a href="'.esc_url($linkURL).'" target="'.esc_attr($target).'" rel="'.esc_attr($nofollow).'" '.$link_attr.'>';
	}
	...
	$getIcon = '';
	if(!empty($linkURL)){
		$getIcon .='<a href="'.esc_url($linkURL).'" target="'.esc_attr($target).'" rel="'.esc_attr($nofollow).'" '.$link_attr.'>';
	}
	...
	$getImg = '';
	if(!empty($linkURL)){
		$getImg .= '<a href="'.esc_url($linkURL).'" target="'.esc_attr($target).'" rel="'.esc_attr($nofollow).'" '.$link_attr.'>';
	}
	...
	if(!empty($linkURL)){
		$getsvg .= '<a href="'.esc_url($linkURL).'" target="'.esc_attr($target).'" rel="'.esc_attr($nofollow).'" '.$link_attr.'>';
	}
