	...
	echo '<div class="tpgb-panel-row">';
		echo '<div class="tpgb-panel-col tpgb-panel-col-35">';
			...
			echo '<div class="tpgb-panel-sec tpgb-welcome-doc tpgb-p-20 tpgb-mt-8 tpgb-mb-8">';
				...
				echo '<a href="https://docs.posimyth.com/tpag/" class="tpgb-panel-btn" title="'.esc_attr__('Read Documentation','tpgb').'" target="_blank" rel="noopener noreferrer">'.esc_html__('Read Documentation','tpgb').'</a>';
			echo '</div>';
			/*Welcome Document*/
		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-65">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-welcome-changelog tpgb-mb-8">';
				...
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('27 Dec 2021','tpgb').' <span class="changelog-version">'.esc_html__('1.2.4','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Fix : Core/Calender Block : Display Rules Attribute bug fix','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
				
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('24 Dec 2021','tpgb').' <span class="changelog-version">'.esc_html__('1.2.3','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Update : Number Counter : Update Option of Prefix & Postfix Both Together','tpgb').'</li>';
						echo '<li>'.esc_html__('Update : Latest version of Splide JS for Carousels- Update : Carousel Slider added Option : MouseWheel & Keyboard Accessibility','tpgb').'</li>';
						echo '<li>'.esc_html__('Update : FlipBox Block : Back Side Alignment option Added','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Post Listing Block : Select Child Terms Fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Blocks Frontend CSS Bug','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
				
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('20 Nov 2021','tpgb').' <span class="changelog-version">'.esc_html__('1.2.2','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Fix : Stylish List : Edit Page Error Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Global Spacing : Save Bug','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
				
				echo '<a href="https://roadmap.theplusblocks.com/updates" class="tpgb-panel-btn tpgb-mt-8" title="'.esc_attr__('change log','tpgb').'" target="_blank" rel="noopener noreferrer">'.esc_html__('Full Change log','tpgb').'</a>';
			echo '</div>';
			/*Welcome Change log*/
			/*Welcome FAQ*/
	...
	echo '<div class="tpgb-panel-row tpgb-mt-8 tp-mt-8-remove">';
		echo '<div class="tpgb-panel-col tpgb-panel-col-50" style="align-content: flex-start;">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-mb-8 tpgb-welcome-tech-sup">';
				...
				echo '<a href="http://m.me/tpagutenberg/" class="tpgb-panel-btn tpgb-mt-8" title="'.esc_attr__('Live Chat','tpgb').'" target="_blank" rel="noopener noreferrer">'.esc_html__('Live Chat','tpgb').'</a>';
				echo '<a href="https://wordpress.org/support/plugin/the-plus-addons-for-block-editor/" class="tpgb-panel-btn-outline-2 tpgb-mt-8" title="'.esc_attr__('Free Support','tpgb').'" target="_blank" rel="noopener noreferrer">'.esc_html__('Free Support','tpgb').'</a>';
			echo '</div>';
			/*technical support*/
			/*Social*/
		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-50">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-mb-8 tpgb-welcome-rate-us">';
				...
				echo '<a href="https://wordpress.org/plugins/the-plus-addons-for-block-editor/#reviews " class="tpgb-panel-btn tpgb-mt-8" title="'.esc_attr__('Rate on WordPress','tpgb').'" target="_blank" rel="noopener noreferrer">'.esc_html__('Rate on WordPress','tpgb').'</a>';
				echo '<a href="https://www.facebook.com/tpagutenberg/reviews/" class="tpgb-panel-btn-outline-2 tpgb-mt-8" title="'.esc_attr__('Rate on Facebook','tpgb').'" target="_blank" rel="noopener noreferrer">'.esc_html__('Rate on Facebook','tpgb').'</a>';
			echo '</div>';
			/*Rate Us*/
			/*feedback*/
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-mt-8 tpgb-mb-8 tpgb-welcome-feedback">';
				...
				echo '<a href="http://m.me/tpagutenberg/" class="tpgb-panel-btn tpgb-mt-8" title="'.esc_attr__('Share Feedback','tpgb').'" target="_blank" rel="noopener noreferrer">'.esc_html__('Share Feedback','tpgb').'</a>';
			echo '</div>';
			/*feedback*/
			/*subscriber*/
