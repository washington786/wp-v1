...
function nirvana_get_option_defaults() {
	...
	$nirvana_defaults = array(
		...
		"nirvana_sliderimg1"		=> esc_url( get_template_directory_uri() )."/images/slider/nirvana-slide1.jpg",
		...
		"nirvana_sliderlink1"		=> "#",
		"nirvana_sliderimg2"		=> esc_url( get_template_directory_uri() )."/images/slider/nirvana-slide2.jpg",
		...
		"nirvana_sliderlink2"		=> "#",
		"nirvana_sliderimg3"		=> esc_url( get_template_directory_uri() )."/images/slider/nirvana-slide3.jpg",
		...
		"nirvana_sliderlink3"		=> "#",
		"nirvana_sliderimg4"		=>  esc_url( get_template_directory_uri() )."/images/slider/nirvana-slide4.jpg",
		...
		"nirvana_comoff"			=> "Show",
		"nirvana_comlabels"			=> 0, // 0 = placeholders, 1 = labels
