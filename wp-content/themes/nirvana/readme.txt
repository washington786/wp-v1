...
* Restored 'entry-content' class on 'pp-afterslider' element to restore missing styling on presentation page elements since 1.6.0
...
* Cleaned up some unused code and moved some settings page code to the companion Serious Settings plugin (in v0.5.13)
...
= 1.5.1.1 =
* Fixed content images sometimes being distorted (since v1.5.1)
